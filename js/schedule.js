...
const BANNER_CONFIG = {
    ...
    image: "assets/banner.png",             // Путь к картинке
    title: "Подписывайся на мой ТГ кагал",          // Заголовок
    description: "",       // Описание
    buttonText: "Перейти",                 // Текст кнопки
    buttonLink: "https://t.me/Daisu4keNarotan",       // Ссылка кнопки
